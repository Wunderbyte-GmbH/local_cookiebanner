...
$string['advancedtext_desc'] = 'Text displayed inside the modal when a user clicks the "Advanced" button.';
$string['cookietext'] = 'Cookie Banner Text';
$string['cookietext_default'] = 'Two cookies are used on this site:
